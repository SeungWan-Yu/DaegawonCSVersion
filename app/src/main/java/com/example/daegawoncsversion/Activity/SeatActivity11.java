...
import com.example.daegawoncsversion.Fragment.TabFragment21;
...
public class SeatActivity11 extends BaseActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seat11);
...
//        waitingnum = intent.getStringExtra("repo");
    ...
    public class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    TabFragment21 fragment21 = new TabFragment21();
                    Bundle bundle21 = new Bundle();
                    bundle21.putStringArrayList("list",list);
                    fragment21.setArguments(bundle21);
                    return fragment21;
                default:
                    return null;
            }
