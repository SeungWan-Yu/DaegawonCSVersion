...
public class ReservechObject {
    ...
    public ReservechObject(String keyCd, String bookingCd, String name, String phone, String visitDt, String cnt, ArrayList<String> tnames){
        this.keyCd=keyCd;
